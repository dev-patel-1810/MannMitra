  ...
  const cards = [
    ...
    },
    {
      ...
      features: [
        ...
        "AI Driven Risk Analytics & Insights",
      ],
    ...
    },
    {
      title: "University",
      color: "bg-orange-600",
      text: "Comprehensive management tools for efficient campus operations.",
      features: [
        "Monitor Logs",
        "Smart Analytics",
        "AI Driven Insights",
        "Utilize On-Campus Professionals",
